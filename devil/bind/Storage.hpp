...
{
	Storage2(T1 const &t1, T2 const &t2) :
...
{
	Storage3(T1 const &t1, T2 const &t2, T3 const &t3) :
...
{
	Storage4(T1 const &t1, T2 const &t2, T3 const &t3, T4 const &t4) :
...
{
	Storage5(T1 const &t1, T2 const &t2, T3 const &t3, T4 const &t4,
		T5 const &t5) :
...
{
	Storage6(T1 const &t1, T2 const &t2, T3 const &t3, T4 const &t4,
